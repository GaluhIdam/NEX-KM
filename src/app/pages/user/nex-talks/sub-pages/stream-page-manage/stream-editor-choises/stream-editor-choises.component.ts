...
@Component({
  selector: 'app-stream-editor-choises',
  templateUrl: './stream-editor-choises.component.html',
  styleUrls: ['./stream-editor-choises.component.css'],
})
export class StreamEditorChoisesComponent implements OnInit, OnDestroy {
  faSearch = faSearch;
  ...
  initStreamData(): void {
    ...
    }&editorChoice=${true}&status=${true}&approval_status=Approved`;
